...
const CertificatePreview: React.FC<InCertificatePreviewProps> = ({ name, onHandleLogout }) => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen w-full flex flex-col justify-center items-center">

      <div
        ref={certificateRef}
        className="hidden lg:block bg-white shadow rounded overflow-auto mb-4"
      ...
      <div className="w-full flex flex-col gap-2 lg:flex-row lg:justify-between lg:w-1/2">
        ...
        <button
          ...
          className="w-sm mt-4 flex items-center justify-center min-h-14  px-4 py-4 text-white font-semibold rounded-lg  space-x-2 bg-green-600 hover:bg-green-700 cursor-pointer"
        >
